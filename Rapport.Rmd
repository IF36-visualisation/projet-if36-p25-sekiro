...
> [Introduction](#section-1) <br> [I. Données](#section-2) <br> [II. Plan d'analyse](#section-3) <br> [III. Exploration](#section-4) <br> [IV. Conclusion](#section-5) <br> [V. Annexe](#section-6) <br>
...
### 3. Analyse comparative des trajectoires démographiques : Pays baltes et Liberia en lumière

<video width="90%" controls style="display: block; margin: 0 auto;">
  <source src="./Images/Tableau.mp4" type="video/mp4">
  Votre navigateur ne supporte pas la balise vidéo.
</video>

Dans le cadre de cette étude, une analyse comparative a été faite sur le logiciel Tableau sur les évolutions démographiques de deux groupes de pays très contrastés : les pays baltes – Estonie, Lettonie et Lituanie – et le Liberia , situé en Afrique de l’Ouest.
...
- Une carte choroplèthe mondiale , colorée selon le taux de croissance démographique annuel , permettant d’identifier visuellement les zones de forte ou faible croissance ;
- Un graphique linéaire illustrant l’évolution de la population totale entre 1950 et 2023 , avec une série distincte pour chaque pays sélectionné ;
- Une mesure complémentaire a également été intégrée : la variation absolue de population, qui montre le nombre réel de personnes gagnées ou perdues chaque année ;
- Un encard à gauche avec du texte dynamique sur la moyenne, minimum et maximum de la croissance selon les pays sélectionnés
- Un filtre interactif au centre (qu'il est possible de replier) pour choisir un ou plusieurs pays et une date pour la carte;

Sur le premier graphe est présent la France, un pays qui a connu une croissance linéaire (négative à l'image des autres pays occidentaux) sans accoup/chute notable à titre d'exemple.
Depuis les années 1990, les trois pays baltes montrent une tendance commune : une baisse de leur population dont une chute brutale lors de la chute de l'URSS. Ce taux négatif l'est resté jusqu'à l'avant-dernière année du dataset (2022). Cette évolution s’explique par plusieurs facteurs. Globaux premièrement :
- Une faible natalité , notamment due à l’émancipation féminine et à l’accès limité à des politiques familiales fortes ;
- Un vieillissement rapide de la population , accentué par une espérance de vie relativement élevée mais sans compensation suffisante en termes de naissances
Mais aussi des particularités unique à ces pays :
- Une émigration importante, particulièrement vers la Russie lors de la chute et vers l’Union européenne après l’élargissement de 2004 ;
- Une immigration forte en 2023, que l'on peut supposer russe et en moindre partie ukrainienne dû au début du conflit Ukraino-russe, qui pourrait expliquer une légère reprise temporaire
...
À l’inverse, le Liberia affiche une croissance démographique élevée, souvent supérieure à 2 % par an. Cependant la moyenne cache un pic notable en 1990. En valeur absolue, ce pic représente une baisse de 500 000 habitants , soit environ 20 % de la population totale en 1989 (estimée à 2,5 millions). Sur Tableau, cette baisse apparaît même plus importante (environ 30 %), ce qui soulève une question légitime : pourquoi ?
La cause de cette chute de population est la Première guerre civile (1989-1990 principalement). Cette guerre (comme toutes les autres guerres, d'autant plus guerre civile) a eu plusieurs conséquences démographiques :
Des pertes humaines directes dues aux combats ;
Une augmentation de la mortalité infantile et maternelle ;
Une déstabilisation administrative , empêchant un recensement précis des naissances ;
Une émigration massive de la population civile vers les pays voisins ;
Une diminution des naissances volontaires pendant la période de conflit ;
Ces éléments expliquent à la fois la chute abrupte de la population et le rebond rapide l’année suivante , lorsque la situation s’est stabilisée.
...
### 4. Quels sont les 10 pays avec les taux de mortalité infantile les plus faibles et les plus élevés en moyenne entre 2000 et 2023 ?
...
### 5. Quels sont les 10 pays représentant la plus forte part de la population mondiale en 2023 ?
...
### 6. Quels pays connaîtront la plus forte croissance démographique entre 2023 et 2100 ?
...
### 7. Quel est l'âge médian des populations par pays en 1950 et en 2023 ?
...
### 8. Évolution de l’espérance de vie à la naissance dans le monde (1950–2100)
...
### 9. Quels sont les 10 pays avec les soldes migratoires nets les plus élevés et les plus faibles entre 2000 et 2023 ?
...
### 10. Existe-t-il une corrélation entre le taux de mortalité infantile et le taux de fécondité total (TFR) en 2023 ?
...
1. **La grande transition démographique** se confirme avec des trajectoires divergentes : vieillissement accéléré des sociétés occidentales et asiatiques contrastant avec la jeunesse persistante de l'Afrique subsaharienne. L'âge médian mondial a augmenté de 10 ans depuis 1950, passant de 24 à 34 ans, avec des écarts allant de 15 ans au Niger à 48 ans au Japon.  

2. **La corrélation entre développement et démographie** apparaît systématiquement : les pays à forte mortalité infantile (>50‰) maintiennent une fécondité élevée (TFR >4), tandis que les sociétés développées connaissent un effondrement de la natalité sous le seuil de renouvellement (1,5 enfants/femme en Europe).  

3. **Le basculement démographique à venir** est spectaculaire : d'ici 2100, 7 des 10 plus fortes croissances démographiques seront africaines, avec la RDC en tête (+325 millions d'habitants). À l'inverse, près de 50 pays perdront plus de 15% de leur population.  

**Difficultés rencontrées** :  
L'hétérogénéité des sources historiques, particulièrement pour les pays en conflit, introduit des incertitudes. La projection des scénarios à l'horizon 2100 reste spéculative, vulnérable aux ruptures (pandémies, conflits, innovations). Le traitement des migrations internationales s'est révélé particulièrement complexe en raison des définitions variables entre pays et des 3 scénarios.  

**Pistes d'approfondissement** :  
- Analyser l'impact du changement climatique sur les migrations et la sécurité alimentaire  
- Étudier le lien entre économique et démographie  
- Explorer les données de fécondité désagrégées par niveau d'éducation  
...
* En ce qui concerne la partie exploration nous nous sommes répartis les questions de la manière suivante :
  ...
  **3. Tableau** Focus sur les pays baltes et le Liberia
  ...
  **7.** Quel est l'âge médian des populations par pays en 1950 et en 2023 ?  
  **ShinyApp**    
  + `Nicolas :` **4.** Quels sont les 10 pays avec les taux de mortalité infantile les plus faibles et les plus élevés en moyenne entre 2000 et 2023 ?   
  **6.**Quels pays connaîtront la plus forte croissance démographique entre 2023 et 2100 ?  
  **8.**Évolution de l’espérance de vie à la naissance dans le monde (1950–2100)   
  + `Zakaria :` **5.** Quels sont les 10 pays représentant la plus forte part de la population mondiale en 2023 ?  
  **9.**  Quels sont les 10 pays avec les soldes migratoires nets les plus élevés et les plus faibles entre 2000 et 2023 ?    
  **10.**  Existe-t-il une corrélation entre le taux de mortalité infantile et le taux de fécondité total (TFR) en 2023 ?
