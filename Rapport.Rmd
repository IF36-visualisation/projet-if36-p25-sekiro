...
top_growth_line <- create_styled_line_plot(
  top_data_rel,
  "Évolution Relative des 10 Pays avec la Plus Forte Croissance (1950-2023)"
)

bottom_decline_line <- create_styled_line_plot(
  bottom_data_rel,
  "Évolution Relative des 10 Pays avec la Plus Forte Décroissance (1950-2023)"
)
